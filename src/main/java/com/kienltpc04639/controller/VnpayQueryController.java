...
public class VnpayQueryController {
    ...
    @PostMapping("/vnpay_query")
    public void handleQueryRequest(
        ...
        String hash_Data = vnp_RequestId + "|" + vnp_Version + "|" + vnp_Command + "|" + vnp_TmnCode + "|" + vnp_TxnRef + "|" + transDate + "|" + vnp_CreateDate + "|" + vnp_IpAddr + "|" + vnp_OrderInfo;
